package org.silvermob.mobile.javademo.activities.ads.gam.original;
...
import org.silvermob.mobile.NativeAsset;
import org.silvermob.mobile.NativeDataAsset;
import org.silvermob.mobile.NativeEventTracker;
import org.silvermob.mobile.NativeImageAsset;
...
import org.silvermob.mobile.PrebidNativeAdListener;
import org.silvermob.mobile.VideoParameters;
import org.silvermob.mobile.addendum.AdViewUtils;
import org.silvermob.mobile.addendum.PbFindSizeError;
import org.silvermob.mobile.api.original.PrebidAdUnit;
import org.silvermob.mobile.api.original.PrebidRequest;
import org.silvermob.mobile.javademo.R;
import org.silvermob.mobile.javademo.activities.BaseAdActivity;
import org.silvermob.mobile.javademo.utils.ImageUtils;
...
public class GamOriginalApiMultiformatBannerVideoNativeInApp extends BaseAdActivity {
    ...
    private BannerParameters createBannerParameters() {
        ...
        parameters.setAdSizes(Sets.newHashSet(new org.silvermob.mobile.AdSize(300, 250)));
        return parameters;
    }

    private VideoParameters createVideoParameters() {
        VideoParameters parameters = new VideoParameters(Lists.newArrayList("video/mp4"));
        parameters.setAdSize(new org.silvermob.mobile.AdSize(320, 480));
        return parameters;
    }
