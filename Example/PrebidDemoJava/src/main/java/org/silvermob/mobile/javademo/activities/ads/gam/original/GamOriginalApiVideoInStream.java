...
import org.silvermob.mobile.InStreamVideoAdUnit;
...
public class GamOriginalApiVideoInStream extends BaseAdActivity {
    ...
    private void createAd() {
        ...
        adUnit.fetchDemand((resultCode, keysMap) -> {
            HashSet<org.silvermob.mobile.AdSize> sizes = new HashSet<>();
            sizes.add(new org.silvermob.mobile.AdSize(WIDTH, HEIGHT));
