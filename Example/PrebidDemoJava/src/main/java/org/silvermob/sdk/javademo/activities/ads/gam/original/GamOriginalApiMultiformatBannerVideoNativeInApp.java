package org.silvermob.sdk.javademo.activities.ads.gam.original;
...
import org.silvermob.sdk.NativeAsset;
import org.silvermob.sdk.NativeDataAsset;
import org.silvermob.sdk.NativeEventTracker;
import org.silvermob.sdk.NativeImageAsset;
...
import org.silvermob.sdk.PrebidNativeAdListener;
...
import org.silvermob.sdk.api.original.PrebidAdUnit;
import org.silvermob.sdk.api.original.PrebidRequest;
import org.silvermob.sdk.javademo.R;
import org.silvermob.sdk.javademo.activities.BaseAdActivity;
import org.silvermob.sdk.javademo.utils.ImageUtils;
...
public class GamOriginalApiMultiformatBannerVideoNativeInApp extends BaseAdActivity {
    ...
    private BannerParameters createBannerParameters() {
        ...
        parameters.setAdSizes(Sets.newHashSet(new org.silvermob.sdk.AdSize(300, 250)));
        return parameters;
    }

    private VideoParameters createVideoParameters() {
        VideoParameters parameters = new VideoParameters(Lists.newArrayList("video/mp4"));
        parameters.setAdSize(new org.silvermob.sdk.AdSize(320, 480));
        return parameters;
    }
