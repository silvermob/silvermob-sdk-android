package org.silvermob.mobile.prebidkotlindemo.activities.ads.gam.original
...
import org.silvermob.mobile.addendum.AdViewUtils.PbFindSizeListener
...
class GamOriginalApiMultiformatBannerVideoNativeStylesActivity : BaseAdActivity() {
    ...
    private fun createBannerParameters(): BannerParameters {
        ...
        params.adSizes = mutableSetOf(org.silvermob.mobile.AdSize(300, 250))
        return params
    }

    private fun createVideoParameters(): VideoParameters {
        val params = VideoParameters(listOf("video/mp4"))
        params.adSize = org.silvermob.mobile.AdSize(320, 480)
        return params
    }
