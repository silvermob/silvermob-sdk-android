...
class GamOriginalNativeInAppFragment : PpmNativeFragment() {
    ...
    private var adUnit: com.silvermob.sdk.NativeAdUnit? = null
    ...
    private fun createAd() {
        ...
        adUnit?.fetchDemand(adRequest) { resultCode ->
            if (resultCode != com.silvermob.sdk.ResultCode.SUCCESS) {
                events.fetchDemandFailure(true)
                adLoader!!.loadAd(adRequest)
                return@fetchDemand
            }
            com.silvermob.sdk.eventhandlers.utils.GamUtils.prepare(adRequest, extras)
    ...
    private fun inflatePrebidNativeAd(
            ad: com.silvermob.sdk.PrebidNativeAd,
            wrapper: ViewGroup
    ) {
    ...
    private fun createAdLoader(
        ...
        val onCustomAdLoaded =
            NativeCustomFormatAd.OnCustomFormatAdLoadedListener { nativeCustomTemplateAd: NativeCustomFormatAd? ->
                ...
                com.silvermob.sdk.addendum.AdViewUtils.findNative(nativeCustomTemplateAd!!, object : com.silvermob.sdk.PrebidNativeAdListener {
     ...
     */
    private class SafeNativeListener(events: Events) : com.silvermob.sdk.PrebidNativeAdEventListener {
