...
package org.silvermob.sdk.renderingtestapp.plugplay.bidding
...
import org.silvermob.sdk.renderingtestapp.data.DemoItem
import org.silvermob.sdk.renderingtestapp.databinding.FragmentMainBinding
import org.silvermob.sdk.renderingtestapp.utils.BaseFragment
import org.silvermob.sdk.renderingtestapp.utils.GdprHelper
import org.silvermob.sdk.renderingtestapp.utils.SegmentAdapterReImpl
import org.silvermob.sdk.renderingtestapp.utils.adapters.DemoItemClickListener
import org.silvermob.sdk.renderingtestapp.utils.adapters.DemoListAdapter
...
class HeaderBiddingFragment : BaseFragment() {
    ...
    private fun initCacheSwitch() {
        ...
        switch.isChecked = SilverMob.isUseCacheForReportingWithRenderingApi()
        switch.setOnCheckedChangeListener { _, isChecked ->
            SilverMob.setUseCacheForReportingWithRenderingApi(isChecked)
        }
    }
