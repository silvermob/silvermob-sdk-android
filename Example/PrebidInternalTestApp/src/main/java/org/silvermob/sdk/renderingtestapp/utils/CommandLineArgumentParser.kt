...
import org.silvermob.sdk.api.mediation.MediationBaseAdUnit
import org.silvermob.sdk.api.mediation.MediationNativeAdUnit
import org.silvermob.sdk.api.rendering.BannerView
import org.silvermob.sdk.api.rendering.BaseInterstitialAdUnit
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.Ext
import org.silvermob.sdk.renderingtestapp.plugplay.utilities.consent.ConsentUpdateManager
...
object CommandLineArgumentParser {
    ...
    fun parse(intent: Intent?, context: Context) {
        ...
        extras.getBoolean("shareGeo").let { shareGeo ->
            SilverMob.setShareGeoLocation(shareGeo)
        }
