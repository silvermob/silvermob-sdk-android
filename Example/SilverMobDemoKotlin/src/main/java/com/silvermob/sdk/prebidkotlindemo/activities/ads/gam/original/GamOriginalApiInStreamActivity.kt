...
class GamOriginalApiInStreamActivity : BaseAdActivity() {
    ...
    private var adUnit: com.silvermob.sdk.InStreamVideoAdUnit? = null
    ...
    private fun createAd() {
        ...
        adUnit = com.silvermob.sdk.InStreamVideoAdUnit(CONFIG_ID, WIDTH, HEIGHT)
        ...
        adUnit?.fetchDemand { _: com.silvermob.sdk.ResultCode?, keysMap: Map<String?, String?>? ->
            ...
            val prebidURL =  com.silvermob.sdk.Util.generateInstreamUriForGam(
                AD_UNIT_ID,
                sizes,
                keysMap
            )
    ...
    private fun configureVideoParameters(): com.silvermob.sdk.VideoParameters {
        return com.silvermob.sdk.VideoParameters(listOf("video/x-flv", "video/mp4")).apply {
            placement = com.silvermob.sdk.Signals.Placement.InStream
