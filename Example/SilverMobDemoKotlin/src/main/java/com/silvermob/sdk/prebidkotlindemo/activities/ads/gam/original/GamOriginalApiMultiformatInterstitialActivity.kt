...
class GamOriginalApiMultiformatInterstitialActivity : BaseAdActivity() {
    ...
    private fun createAd() {
        ...
        adUnit = com.silvermob.sdk.InterstitialAdUnit(configId, EnumSet.of(com.silvermob.sdk.api.data.AdUnitFormat.BANNER, com.silvermob.sdk.api.data.AdUnitFormat.VIDEO))
