...
import com.silvermob.sdk.NativeEventTracker.EVENT_TRACKING_METHOD
...
class GamOriginalApiNativeInAppActivity : BaseAdActivity() {
    ...
    private fun createAd() {
        ...
        adUnit = com.silvermob.sdk.NativeAdUnit(CONFIG_ID)
    ...
    private fun inflatePrebidNativeAd(ad: com.silvermob.sdk.PrebidNativeAd, wrapper: ViewGroup) {
