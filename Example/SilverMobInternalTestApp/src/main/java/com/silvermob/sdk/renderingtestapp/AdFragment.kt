...
package com.silvermob.sdk.renderingtestapp
...
abstract class AdFragment : BaseFragment() {
    ...
    protected var refreshDelay = com.silvermob.sdk.SilverMob.AUTO_REFRESH_DELAY_MIN / 1000
    ...
    override fun initUi(view: View, savedInstanceState: Bundle?) {
        arguments?.let {
            ...
            com.silvermob.sdk.SilverMob.setStoredAuctionResponse(storedAuctionResponse)
            ...
            it.getString(ARGUMENT_ACCOUNT_ID)?.let { accountId ->
                ...
                com.silvermob.sdk.SilverMob.setServerAccountId(accountId)
            }
        }
    ...
    protected open fun configureNativeAdUnit(nativeAdUnit: com.silvermob.sdk.api.mediation.MediationNativeAdUnit) {
    ...
    private fun setNoBidsAccountId(enable: Boolean) {
        if (enable) {
            com.silvermob.sdk.SilverMob.setServerAccountId(getString(R.string.prebid_account_id_prod_no_bids))
        } else {
    ...
    protected fun configureOriginalPrebid() {
        val hostUrl = com.silvermob.sdk.SilverMob.getPrebidServerHost().hostUrl
        val host = com.silvermob.sdk.Host.CUSTOM
        host.hostUrl = hostUrl
        com.silvermob.sdk.SilverMob.setServerAccountId(com.silvermob.sdk.SilverMob.getPrebidServerAccountId())
        com.silvermob.sdk.SilverMob.initializeSdk(requireContext(), null)
    }
