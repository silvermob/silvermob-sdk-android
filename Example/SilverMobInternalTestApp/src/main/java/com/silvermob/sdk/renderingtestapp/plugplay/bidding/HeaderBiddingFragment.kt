...
package com.silvermob.sdk.renderingtestapp.plugplay.bidding
...
import com.silvermob.sdk.renderingtestapp.utils.GdprHelper
import com.silvermob.sdk.renderingtestapp.utils.SegmentAdapterReImpl
import com.silvermob.sdk.renderingtestapp.utils.adapters.DemoItemClickListener
import com.silvermob.sdk.renderingtestapp.utils.adapters.DemoListAdapter
...
class HeaderBiddingFragment : BaseFragment() {
    ...
    private fun initCacheSwitch() {
        ...
        switch.isChecked = com.silvermob.sdk.SilverMob.isUseCacheForReportingWithRenderingApi()
        switch.setOnCheckedChangeListener { _, isChecked ->
            com.silvermob.sdk.SilverMob.setUseCacheForReportingWithRenderingApi(isChecked)
        }
    }
