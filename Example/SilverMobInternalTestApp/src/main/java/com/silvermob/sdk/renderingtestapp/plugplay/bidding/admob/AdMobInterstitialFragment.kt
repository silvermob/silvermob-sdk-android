...
open class AdMobInterstitialFragment : AdFragment() {
    ...
    override fun initAd(): Any? {
        ...
        var adUnitFormat = EnumSet.of(com.silvermob.sdk.api.data.AdUnitFormat.DISPLAY)
        if (isVideo) adUnitFormat = EnumSet.of(com.silvermob.sdk.api.data.AdUnitFormat.VIDEO)
