...
open class AdMobRewardedFragment : AdFragment() {
    ...
    protected var adUnit: com.silvermob.sdk.api.mediation.MediationRewardedVideoAdUnit? = null
    ...
    override fun initAd(): Any? {
        extras = Bundle()
        val mediationUtils = com.silvermob.sdk.admob.AdMobMediationRewardedUtils(extras)
