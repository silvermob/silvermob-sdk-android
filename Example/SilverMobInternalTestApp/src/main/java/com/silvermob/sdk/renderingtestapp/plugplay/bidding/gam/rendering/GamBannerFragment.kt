...
open class GamBannerFragment : AdFragment(),
        com.silvermob.sdk.api.rendering.listeners.BannerViewListener {
    ...
    protected open fun initBanner(configId: String?, eventHandler: com.silvermob.sdk.eventhandlers.GamBannerEventHandler): com.silvermob.sdk.api.rendering.BannerView {
        return com.silvermob.sdk.api.rendering.BannerView(
                requireContext(),
                configId,
                eventHandler
        )
