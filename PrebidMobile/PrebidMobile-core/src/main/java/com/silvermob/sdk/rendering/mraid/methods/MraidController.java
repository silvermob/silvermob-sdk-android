...
public class MraidController {
    ...
    public void handleMraidEvent(MraidEvent event, HTMLCreative creative,
        ...
        switch (event.mraidAction) {
            case JSInterface.ACTION_EXPAND:
            ...
            case JSInterface.ACTION_CLOSE:
                close(oldWebViewBase);
                break;

            case JSInterface.ACTION_PLAY_VIDEO:
                playVideo(oldWebViewBase, event);
                break;

            case JSInterface.ACTION_OPEN:
            ...
            case JSInterface.ACTION_STORE_PICTURE:
                storePicture(oldWebViewBase, event.mraidActionHelper);
                break;

            case JSInterface.ACTION_CREATE_CALENDAR_EVENT:
                createCalendarEvent(oldWebViewBase.getMRAIDInterface(), event.mraidActionHelper);
                break;

            case JSInterface.ACTION_ORIENTATION_CHANGE:
                changeOrientation();
                break;

            case JSInterface.ACTION_RESIZE:
                resize(oldWebViewBase);
                break;
            case JSInterface.ACTION_UNLOAD:
