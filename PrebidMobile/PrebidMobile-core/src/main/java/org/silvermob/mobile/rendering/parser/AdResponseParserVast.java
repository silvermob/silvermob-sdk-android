...
package org.silvermob.mobile.rendering.parser;
...
import org.silvermob.mobile.rendering.errors.VastParseError;
import org.silvermob.mobile.rendering.networking.parameters.BasicParameterBuilder;
import org.silvermob.mobile.rendering.utils.helpers.Utils;
import org.silvermob.mobile.rendering.video.VideoAdEvent;
import org.silvermob.mobile.rendering.video.vast.Ad;
import org.silvermob.mobile.rendering.video.vast.AdVerifications;
import org.silvermob.mobile.rendering.video.vast.ClickTracking;
import org.silvermob.mobile.rendering.video.vast.Companion;
import org.silvermob.mobile.rendering.video.vast.Creative;
import org.silvermob.mobile.rendering.video.vast.Extension;
import org.silvermob.mobile.rendering.video.vast.Impression;
import org.silvermob.mobile.rendering.video.vast.InLine;
import org.silvermob.mobile.rendering.video.vast.MediaFile;
import org.silvermob.mobile.rendering.video.vast.VAST;
...
public class AdResponseParserVast extends AdResponseParserBase {
    ...
    private ArrayList<org.silvermob.mobile.rendering.video.vast.Tracking> trackings;
    private ArrayList<ClickTracking> clickTrackings;
    private ArrayList<Impression> impressions;

    private VAST vast;

    public ArrayList<org.silvermob.mobile.rendering.video.vast.Tracking> getTrackings() {
        return trackings;
    }
    ...
    public ArrayList<org.silvermob.mobile.rendering.video.vast.Tracking> getTrackingEvents(VAST vast, int index) {
    ...
    public ArrayList<org.silvermob.mobile.rendering.video.vast.Tracking> getAllTrackings(AdResponseParserVast parserVast, int index) {
    ...
    public ArrayList<String> getTrackingByType(VideoAdEvent.Event event) {
        Iterator<org.silvermob.mobile.rendering.video.vast.Tracking> iterator = trackings.iterator();

        ArrayList<String> urls = new ArrayList<>();

        while (iterator.hasNext()) {
            org.silvermob.mobile.rendering.video.vast.Tracking t = iterator.next();
     ...
     */
    public static org.silvermob.mobile.rendering.video.vast.Tracking findTracking(ArrayList<org.silvermob.mobile.rendering.video.vast.Tracking> trackingEvents) {
        if (trackingEvents != null) {
            for (org.silvermob.mobile.rendering.video.vast.Tracking tracking : trackingEvents) {
