...
import org.silvermob.sdk.LogUtil.PrebidLogger;
...
import org.silvermob.sdk.configuration.PBSConfig;
import org.silvermob.sdk.core.BuildConfig;
import org.silvermob.sdk.rendering.listeners.SdkInitializationListener;
import org.silvermob.sdk.rendering.mraid.MraidEnv;
import org.silvermob.sdk.rendering.sdk.InitializationNotifier;
import org.silvermob.sdk.rendering.sdk.PrebidContextHolder;
import org.silvermob.sdk.rendering.sdk.SdkInitializer;
...
public class SilverMob {
    ...
    /**
     * Please use {@link SilverMob#setLogLevel(LogLevel)}, this field will become private in next releases.
     */
    @Deprecated
    ...
    private static final String TAG = SilverMob.class.getSimpleName();
    ...
    public static void setUseCacheForReportingWithRenderingApi(boolean useCacheForReportingWithRenderingApi) {
        SilverMob.useCacheForReportingWithRenderingApi = useCacheForReportingWithRenderingApi;
    }
    ...
    public static void setTimeoutMillis(int timeoutMillis) {
        SilverMob.timeoutMillis = timeoutMillis;
    }

    public static void setServerAccountId(String accountId) {
        SilverMob.accountId = accountId;
    }
    ...
    private static void setPrebidServerHost(Host host) {
        if (host == null) {
    ...
    public static void setShareGeoLocation(boolean share) {
        SilverMob.shareGeoLocation = share;
    }
    ...
    public static void setExternalUserIds(List<ExternalUserId> externalUserIds) {
        SilverMob.externalUserIds = externalUserIds;
    }
    ...
    public static List<ExternalUserId> getExternalUserIds() {
        return SilverMob.externalUserIds;
    }
    ...
    public static void setCustomHeaders(@Nullable HashMap<String, String> customHeaders) {
        if (customHeaders != null) {
            SilverMob.customHeaders = customHeaders;
        }
    }
    ...
    public static HashMap<String, String> getCustomHeaders() {
        return SilverMob.customHeaders;
    }


    /**
     * Initializes the main SDK classes and makes request to Prebid server to check its status.
     * You have to set host url ({@link SilverMob#setPrebidServerHost(Host)}) before calling this method.
     * If you use custom /status endpoint set it with ({@link SilverMob#setCustomStatusEndpoint(String)}) before starting initialization.
     * <p>
    ...
    public static void setStoredAuctionResponse(@Nullable String storedAuctionResponse) {
        SilverMob.storedAuctionResponse = storedAuctionResponse;
    }
    ...
    public static void assignNativeAssetID(boolean assignNativeAssetID) {
        SilverMob.assignNativeAssetID = assignNativeAssetID;
    }
    ...
    public static void checkGoogleMobileAdsCompatibility(@NonNull String googleAdsVersion) {
        int[] prebidVersion = parseVersion(SilverMob.TESTED_GOOGLE_SDK_VERSION);
     ...
     * Request to /status is sent when you call {@link SilverMob#initializeSdk(Context, SdkInitializationListener)}.
     *
    ...
    public static void setCreativeFactoryTimeout(int creativeFactoryTimeout) {
        SilverMob.creativeFactoryTimeout = creativeFactoryTimeout;
    }
    ...
    public static void setCreativeFactoryTimeoutPreRenderContent(int creativeFactoryTimeoutPreRenderContent) {
        SilverMob.creativeFactoryTimeoutPreRenderContent = creativeFactoryTimeoutPreRenderContent;
    }
