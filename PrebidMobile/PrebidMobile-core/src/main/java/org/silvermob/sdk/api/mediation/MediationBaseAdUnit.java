...
package org.silvermob.sdk.api.mediation;
...
public abstract class MediationBaseAdUnit {
    ...
    protected MediationBaseAdUnit(
        ...
        adUnitConfig.setAutoRefreshDelay(SilverMob.AUTO_REFRESH_DELAY_MIN / 1000);
        initSdk(context);
    ...
    protected void fetchDemand(@NonNull OnFetchCompleteListener listener) {
        ...
        final Host bidServerHost = SilverMob.getPrebidServerHost();
