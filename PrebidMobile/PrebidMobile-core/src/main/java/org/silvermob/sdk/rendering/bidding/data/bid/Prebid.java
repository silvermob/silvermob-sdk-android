...
package org.silvermob.sdk.rendering.bidding.data.bid;

import static org.silvermob.sdk.rendering.utils.helpers.Utils.addValue;
...
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.mapper.PluginRendererListMapper;
...
public class Prebid {
    ...
    public static JSONObject getJsonObjectForBidRequest(
        ...
        if (SilverMob.isUseCacheForReportingWithRenderingApi() || config.isOriginalAdUnit()) {
        ...
        if(SilverMob.getIncludeWinnersFlag()){
            Utils.addValue(targeting, "includewinners", "true");
        }

        if(SilverMob.getIncludeBidderKeysFlag()){
    ...
    private static void addStoredAuctionResponse(JSONObject prebid) {
        final String storedAuctionResponse = SilverMob.getStoredAuctionResponse();
    ...
    private static void addStoredBidResponse(JSONObject prebid) {
        final Map<String, String> storedBidResponseMap = SilverMob.getStoredBidResponses();
