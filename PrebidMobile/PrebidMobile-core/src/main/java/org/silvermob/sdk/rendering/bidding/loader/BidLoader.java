...
package org.silvermob.sdk.rendering.bidding.loader;
...
import org.silvermob.sdk.rendering.networking.modelcontrollers.BidRequester;
import org.silvermob.sdk.rendering.networking.parameters.AdRequestInput;
import org.silvermob.sdk.rendering.utils.helpers.RefreshTimerTask;
...
public class BidLoader {
    ...
    private void checkTmax(
        ...
        if (!sTimeoutHasChanged && extMap.containsKey(TMAX_REQUEST_KEY)) {
            ...
            SilverMob.setTimeoutMillis(timeout);
