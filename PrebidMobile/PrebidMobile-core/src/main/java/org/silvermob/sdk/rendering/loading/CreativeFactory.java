...
package org.silvermob.sdk.rendering.loading;
...
import org.silvermob.sdk.rendering.listeners.CreativeResolutionListener;
...
import org.silvermob.sdk.rendering.models.TrackingEvent;
...
import org.silvermob.sdk.rendering.video.RewardedVideoCreative;
import org.silvermob.sdk.rendering.video.VideoAdEvent;
import org.silvermob.sdk.rendering.video.VideoCreative;
import org.silvermob.sdk.rendering.video.VideoCreativeModel;
import org.silvermob.sdk.rendering.video.vast.VASTErrorCodes;
...
public class CreativeFactory {
    ...
    private void attemptAuidCreative() throws Exception {
        ...
        long creativeDownloadTimeout = SilverMob.getCreativeFactoryTimeout();
        if (creativeModel.getAdConfiguration().isAdType(AdFormat.INTERSTITIAL)) {
            creativeDownloadTimeout = SilverMob.getCreativeFactoryTimeoutPreRenderContent();
        }
    ...
    private void attemptVastCreative() {
        ...
        try {
            ...
            markWorkStart(SilverMob.getCreativeFactoryTimeoutPreRenderContent());
            newCreative.load();
        } catch (Exception exception) {
