...
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.App;
...
public class AppInfoParameterBuilder extends ParameterBuilder {
    ...
    public void appendBuilderParameters(AdRequestInput adRequestInput) {
        ...
        app.getPublisher().id = SilverMob.getPrebidServerAccountId();
        ...
        app.getExt().put("prebid", Prebid.getJsonObjectForApp(BasicParameterBuilder.DISPLAY_MANAGER_VALUE, SilverMob.SDK_VERSION));
