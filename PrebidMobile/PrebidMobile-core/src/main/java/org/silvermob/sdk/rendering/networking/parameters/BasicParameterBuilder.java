...
import static org.silvermob.sdk.SilverMob.SDK_VERSION;
...
public class BasicParameterBuilder extends ParameterBuilder {
    ...
    static final String DISPLAY_MANAGER_VALUE = "silvermob-prebid-sdk";
    ...
    private void configureBidRequest(BidRequest bidRequest, String uuid) {
        ...
        bidRequest.getExt().put("prebid", Prebid.getJsonObjectForBidRequest(SilverMob.getPrebidServerAccountId(), isVideo, adConfiguration));
    ...
    private int[] getApiFrameworks() {
        ...
        if (SilverMob.sendMraidSupportParams) {
