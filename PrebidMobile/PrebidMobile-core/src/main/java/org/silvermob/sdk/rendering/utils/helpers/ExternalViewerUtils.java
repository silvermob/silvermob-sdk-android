...
package org.silvermob.sdk.rendering.utils.helpers;
...
import org.silvermob.sdk.rendering.listeners.OnBrowserActionResultListener.BrowserActionResult;
...
public class ExternalViewerUtils {
    ...
    public static void startBrowser(Context context, String url, int broadcastId,
        ...
        if (!SilverMob.useExternalBrowser && isActivityCallable(context, intent)) {
            startActivity(context, intent);
