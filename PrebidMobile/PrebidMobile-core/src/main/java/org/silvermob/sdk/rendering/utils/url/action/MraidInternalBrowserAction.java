...
package org.silvermob.sdk.rendering.utils.url.action;
...
import org.silvermob.sdk.rendering.utils.url.ActionNotResolvedException;
import org.silvermob.sdk.rendering.utils.url.UrlHandler;
...
public class MraidInternalBrowserAction implements UrlAction {
    ...
    public boolean shouldOverrideUrlLoading(Uri uri) {
        ...
        return SilverMob.SCHEME_HTTP.equals(scheme) || SilverMob.SCHEME_HTTPS.equals(scheme);
    }
    ...
    void handleInternalBrowserAction(final Context context, BaseJSInterface baseJSInterface, String url) {
        baseJSInterface.followToOriginalUrl(url, new RedirectUrlListener() {
            ...
            public void onSuccess(String url, String contentType) {
                ...
                } else if (url != null && (url.startsWith(SilverMob.SCHEME_HTTP) || url.startsWith(SilverMob.SCHEME_HTTPS))) {
