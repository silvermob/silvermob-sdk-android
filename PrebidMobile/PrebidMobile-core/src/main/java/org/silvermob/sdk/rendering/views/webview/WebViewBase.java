...
import static org.silvermob.sdk.rendering.views.webview.AdWebViewClient.AdAssetsLoadedListener;
...
public class WebViewBase extends AdWebView implements AdAssetsLoadedListener {
    ...
    public void loadAd() {
         ...
         * via-javascript
         * ***/
        loadDataWithBaseURL(SilverMob.SCHEME_HTTPS + "://" + domain + "/", adHTML, "text/html", "utf-8", null);
    }
