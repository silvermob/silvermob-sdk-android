...
import org.silvermob.sdk.reflection.sdk.UserConsentManagerReflection;
...
import org.silvermob.sdk.testutils.BaseSetup;
...
public class TargetingParamsTest extends BaseSetup {
    ...
    public void setup() {
        ...
        SilverMob.initializeSdk(activity, null);
    ...
    public void testCOPPAFlagWithoutContext() {
        //given
        SilverMob.initializeSdk(null, null);
