...
package org.silvermob.sdk.rendering.networking.parameters;
...
import static org.silvermob.sdk.rendering.networking.parameters.BasicParameterBuilder.KEY_OM_PARTNER_NAME;
import static org.silvermob.sdk.rendering.networking.parameters.BasicParameterBuilder.KEY_OM_PARTNER_VERSION;
import static org.silvermob.sdk.rendering.networking.parameters.BasicParameterBuilder.VIDEO_INTERSTITIAL_PLAYBACK_END;
...
import org.silvermob.sdk.ExternalUserId;
import org.silvermob.sdk.NativeTitleAsset;
...
import org.silvermob.sdk.api.rendering.pluginrenderer.PrebidMobilePluginRegister;
...
import org.silvermob.sdk.rendering.bidding.data.bid.Prebid;
import org.silvermob.sdk.rendering.models.AdPosition;
import org.silvermob.sdk.rendering.models.PlacementType;
import org.silvermob.sdk.rendering.models.openrtb.BidRequest;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.Ext;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.Imp;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.Native;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.PluginRendererList;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.User;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.devices.Geo;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.imps.Banner;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.imps.Video;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.imps.pmps.Format;
import org.silvermob.sdk.rendering.models.openrtb.bidRequests.source.Source;
import org.silvermob.sdk.rendering.sdk.ManagersResolver;
import org.silvermob.sdk.rendering.session.manager.OmAdSessionManager;
import org.silvermob.sdk.rendering.utils.helpers.Utils;
...
public class BasicParameterBuilderTest {
    ...
    public void cleanup() throws Exception {
        ...
        SilverMob.sendMraidSupportParams = true;
        SilverMob.useExternalBrowser = false;
        SilverMob.isCoppaEnabled = false;
        SilverMob.clearStoredBidResponses();
        SilverMob.setStoredAuctionResponse(null);

        SilverMob.unregisterPluginRenderer(otherPlugin);
    }
    ...
    public void sourceOmidValues_renderingApi_defaultValues() throws JSONException {
        ...
        assertEquals(SilverMob.SDK_VERSION, sourceExtJson.getString("omidpv"));
    }
    ...
    public void whenAppendParametersAndBannerType_ImpWithValidBannerObject() throws JSONException {
        ...
        SilverMob.addStoredBidResponse("bidderTest", "123456");
        SilverMob.setStoredAuctionResponse("storedResponse");
    ...
    public void whenAppendParametersAndSendMraidSupportParamsFalse_NoMraidApi() {
        ...
        SilverMob.sendMraidSupportParams = false;
    ...
    public void whenAppendParametersAndUseExternalBrowserTrueAndBrowserActivityAvailable_ClickBrowserEqualsOne() {
        ...
        SilverMob.useExternalBrowser = true;
    ...
    throws JSONException {
        ...
        org.silvermob.sdk.rendering.models.openrtb.bidRequests.Ext impExt = adRequestInput.getBidRequest().getImp().get(0).getExt();
    ...
    public void whenSetPluginRendererList_pluginRendererIsIndexed() throws JSONException {
        // Given
        SilverMob.registerPluginRenderer(otherPlugin);
        AdUnitConfiguration configuration = new AdUnitConfiguration();
        configuration.setIsOriginalAdUnit(false);
        configuration.setAdFormat(AdFormat.BANNER);
    ...
    private BidRequest getExpectedBidRequest(
        ...
        bidRequest.getExt().put(
                "prebid",
                Prebid.getJsonObjectForBidRequest(SilverMob.getPrebidServerAccountId(), isVideo, adConfiguration)
        );
        //if coppaEnabled - set 1, else No coppa is sent
        if (SilverMob.isCoppaEnabled) {
    ...
    private Imp getExpectedImp(AdUnitConfiguration adConfiguration, String uuid) {
        ...
        imp.displaymanagerver = SilverMob.SDK_VERSION;
        ...
        // 0 == embedded, 1 == native
        imp.clickBrowser = !SilverMob.useExternalBrowser && browserActivityAvailable ? 0 : 1;
        imp.id = uuid;
