...
import org.silvermob.sdk.reflection.sdk.PrebidMobileReflection;
...
public class SilverMobTest {
    ...
    public void testOnSDKInitWithoutVideoPreCache() throws Exception {
        ...
        SilverMob.initializeSdk(context, mockSdkInitListener);
    ...
    public void setStoreAuctionResponse_EqualsGetStoredAuctionResponse() {
        ...
        SilverMob.setStoredAuctionResponse(expected);
        assertEquals(expected, SilverMob.getStoredAuctionResponse());
    }
    ...
    public void addAndClearStoredBidResponseMap_ReturnExpectedResult() {
        ...
        SilverMob.addStoredBidResponse("bidder1", "1111");
        SilverMob.addStoredBidResponse("bidder2", "2222");

        assertEquals(expectedMap, SilverMob.getStoredBidResponses());
