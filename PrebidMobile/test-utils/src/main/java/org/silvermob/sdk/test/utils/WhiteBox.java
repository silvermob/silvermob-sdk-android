...
package org.silvermob.sdk.test.utils;
...
public class WhiteBox {
    ...
    public static <T> T getInternalState(Object target, String field) {
        ...
        try {
            Field f = org.silvermob.sdk.test.utils.WhiteBoxHelpers.getFieldFromHierarchy(c, field);
    ...
    public static Field field(Class<?> declaringClass, String fieldName) {
        return org.silvermob.sdk.test.utils.WhiteBoxHelpers.getFieldFromHierarchy(declaringClass, fieldName);
    }

    public static Method method(Class<?> declaringClass, String methodName, Class<?>... parameterTypes) {
        return org.silvermob.sdk.test.utils.WhiteBoxHelpers.getMethod(declaringClass, methodName, parameterTypes);
    }
}
