...
public class AdResponseParserVast extends AdResponseParserBase {
    ...
    private ArrayList<com.silvermob.sdk.rendering.video.vast.Tracking> trackings;
    private ArrayList<ClickTracking> clickTrackings;
    private ArrayList<Impression> impressions;

    private VAST vast;

    public ArrayList<com.silvermob.sdk.rendering.video.vast.Tracking> getTrackings() {
        return trackings;
    }
    ...
    public ArrayList<com.silvermob.sdk.rendering.video.vast.Tracking> getTrackingEvents(VAST vast, int index) {
    ...
    public ArrayList<com.silvermob.sdk.rendering.video.vast.Tracking> getAllTrackings(AdResponseParserVast parserVast, int index) {
    ...
    public ArrayList<String> getTrackingByType(VideoAdEvent.Event event) {
        Iterator<com.silvermob.sdk.rendering.video.vast.Tracking> iterator = trackings.iterator();

        ArrayList<String> urls = new ArrayList<>();

        while (iterator.hasNext()) {
            com.silvermob.sdk.rendering.video.vast.Tracking t = iterator.next();
     ...
     */
    public static com.silvermob.sdk.rendering.video.vast.Tracking findTracking(ArrayList<com.silvermob.sdk.rendering.video.vast.Tracking> trackingEvents) {
        if (trackingEvents != null) {
            for (com.silvermob.sdk.rendering.video.vast.Tracking tracking : trackingEvents) {
