...
public class VideoDownloadTask extends FileDownloadTask {
    ...
    @Override
    public BaseNetworkTask.GetUrlResult sendRequest(BaseNetworkTask.GetUrlParams param) throws Exception {
    ...
    @Override
    protected void processData(URLConnection connection, BaseNetworkTask.GetUrlResult result) throws IOException {
    ...
    private void readAndWriteData(URLConnection in, BaseNetworkTask.GetUrlResult result, OutputStream out,
    ...
    private BaseNetworkTask.GetUrlResult createResult(BaseNetworkTask.GetUrlParams param)
    throws Exception {
        result = new BaseNetworkTask.GetUrlResult();
        String shortenedPath = getShortenedPath();
        if (file.exists()) {
