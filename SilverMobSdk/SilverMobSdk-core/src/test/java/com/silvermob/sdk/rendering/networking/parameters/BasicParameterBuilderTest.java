...
import com.silvermob.sdk.rendering.models.openrtb.bidRequests.PluginRendererList;
...
public class BasicParameterBuilderTest {
    ...
    private BidRequest getExpectedBidRequest(
        ...
        source.setTid(uuid);
        source.getExt().put(BasicParameterBuilder.KEY_OM_PARTNER_NAME, OmAdSessionManager.PARTNER_NAME);
        source.getExt().put(BasicParameterBuilder.KEY_OM_PARTNER_VERSION, OmAdSessionManager.PARTNER_VERSION);
    ...
    private Video getExpectedVideoImpValues(Imp imp, AdUnitConfiguration adConfiguration) {
        ...
        video.playbackend = BasicParameterBuilder.VIDEO_INTERSTITIAL_PLAYBACK_END;//On Leaving Viewport or when Terminated by User
