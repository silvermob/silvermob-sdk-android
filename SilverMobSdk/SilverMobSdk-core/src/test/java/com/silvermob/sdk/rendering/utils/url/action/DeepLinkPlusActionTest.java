...
import static com.silvermob.sdk.rendering.utils.url.action.DeepLinkPlusAction.*;
...
public class DeepLinkPlusActionTest {
    ...
    throws ActionNotResolvedException {
        ...
        List<String> primaryTrackingUrl = validDeepLinkPlusUri.getQueryParameters(DeepLinkPlusAction.QUERY_PRIMARY_TRACKING_URL);
    ...
    throws ActionNotResolvedException {
        ...
        String fallbackUrl = validFallbackDeepLinkUri.getQueryParameter(DeepLinkPlusAction.QUERY_FALLBACK_URL);
        List<String> fallbackTrackingUrls = validFallbackDeepLinkUri.getQueryParameters(DeepLinkPlusAction.QUERY_FALLBACK_TRACKING_URL);
