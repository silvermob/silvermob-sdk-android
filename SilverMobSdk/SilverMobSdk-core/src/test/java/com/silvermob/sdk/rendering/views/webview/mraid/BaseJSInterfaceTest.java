...
public class BaseJSInterfaceTest {
    ...
    public void whenGetLocationAndLocationAvailable_ReturnLocationJson() throws JSONException {
        ...
        locationJson.put(JSInterface.LOCATION_LAT, 1.0);
        locationJson.put(JSInterface.LOCATION_LON, 2.0);
        locationJson.put(JSInterface.LOCATION_TYPE, 1);
        locationJson.put(JSInterface.LOCATION_ACCURACY, 3F);
        locationJson.put(JSInterface.LOCATION_LASTFIX, (long) 4);
    ...
    public void whenGetLocationAndLocationNotAvailable_ReturnError() {
        ...
        Assert.assertEquals(JSInterface.LOCATION_ERROR, spyBaseJSInterface.getLocation());
    }
    ...
    public void whenGetAppOrientation_ReturnAppOrientation() throws JSONException {
        ...
        appOrientation.put(JSInterface.DEVICE_ORIENTATION, "landscape");
        appOrientation.put(JSInterface.DEVICE_ORIENTATION_LOCKED, true);
